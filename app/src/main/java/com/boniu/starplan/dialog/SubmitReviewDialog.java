 ...
 * 提交审核
 */
public class SubmitReviewDialog extends Dialog {
    ...
    public SubmitReviewDialog(@NonNull Context context, NoticeBean noticeBean, DialogReturnInterfaces dialogReturnInterfaces) {
    ...
    private void initView() {
        ...
        tvContent.setText(Html.fromHtml(noticeBean.getContent()+""));
