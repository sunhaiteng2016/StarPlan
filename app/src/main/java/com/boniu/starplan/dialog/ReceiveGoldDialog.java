...
public class ReceiveGoldDialog extends Dialog {
    ...
    public ReceiveGoldDialog(@NonNull Context context) {
        super(context, R.style.CustomProgressDialog);
    }

    public ReceiveGoldDialog(@NonNull Context context, int goldNumber) {
        super(context, R.style.CustomProgressDialog);
        this.goldNum = goldNumber;
    }

    public ReceiveGoldDialog(@NonNull Context context, int goldNumber, String id, ReceiveCallback callback) {
        super(context, R.style.CustomProgressDialog);
        this.goldNum = goldNumber;
        this.id = id;
