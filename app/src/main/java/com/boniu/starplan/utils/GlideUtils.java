...
public class GlideUtils {
   ...
   /* public void LoadFragmentBitmap(android.app.Fragment fragment,String path,ImageView imageView,int placeid,int errorid,String bitmapOrgif){
    ...
    /*public void LoadSupportv4FragmentBitmap(android.support.v4.app.Fragment fragment,String path,ImageView imageView,int placeid,int errorid,String bitmapOrgif){
        if(bitmapOrgif==null||bitmapOrgif.equals(LOAD_BITMAP)){
            ...
            Glide.with(fragment).asGif().load(path).into(imageView);
        }
    }*/
    //---------------------圆形图片-------------------
    ...
    public void LoadContextCircleBitmap(Context context, String path, ImageView imageView) {
        RequestOptions options = new RequestOptions()
                .circleCrop();
        options.placeholder(R.mipmap.shibai);
        options.error(R.mipmap.shibai);
        Glide.with(context).load(path).apply(options).into(imageView);
    }

    @SuppressWarnings("unchecked")
    public void LoadContextCircleBitmap(Context context, int id, ImageView imageView) {
        RequestOptions options = new RequestOptions()
                .circleCrop();
   ...
   /* @SuppressWarnings("unchecked")
    ...
    public void LoadContextRoundBitmapsss(Context context, String path, ImageView imageView, int roundradius) {
        RequestOptions myOptions = new RequestOptions()
                .centerCrop()
                .transform(new GlideRoundTransform(context, roundradius));
        Glide.with(context).load(path).apply(myOptions).into(imageView);
